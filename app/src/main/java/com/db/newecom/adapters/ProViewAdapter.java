...
import com.db.newecom.ui.activity.ProImageViewerActivity;
...
public class ProViewAdapter extends PagerAdapter {
    ...
    public ProViewAdapter(Activity activity, String type, List<ProImageList> proImageLists) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        imageView.setOnClickListener(v -> {
            if (type.equals("pro_image")) {
                ConstantApi.proImageLists.clear();
                ConstantApi.proImageLists.addAll(proImageLists);
                activity.startActivity(new Intent(activity, ProImageViewerActivity.class)
